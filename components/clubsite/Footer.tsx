...
const Footer = () => {
    return (
        <div>
            <div className="flex flex-wrap sm:flex-nowrap mt-16 sm:mt-20 min-h-20 sm:px-20 border-t border-[#333333] pt-6 sm:py-6 justify-around sm:justify-between">
                <div className="w-1/2 sm:w-auto flex flex-col sm:mt-3">
                    ...
                    <div className="text-neutral-300 text-sm -mt-1">
                        Funding for team PC and data subscriptions.
                    </div>
                </div>
