  ...
  return (
    <div>
      <div className="flex flex-col text-center pt-36">
        ...
        <a
          className="box text-neutral-200 rounded-lg bg-black border border-[#333333] mx-auto px-9 py-2 mt-4 hover:border-[#56461a] hover:bg-[#56461a]/30 transition duration-200 ease-in-out"
