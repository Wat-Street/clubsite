  ...
  return (
    <div>
      ...
      <div className="hidden md:block">
        <div className="lg:h-80 md:h-64 sm:h-72 h-80 w-full rounded-md p-4 border border-1 border-[#333333] relative group/card hover:bg-[#56461a]/20 hover:border-[#56461a] transition ease-in-out duration-300">
          ...
          <div className="absolute bottom-0 pb-4 -ml-4 px-4 w-full">
            ...
            <div className="flex w-full mt-2">
              <a
                ...
                className={props.githubLink ? `w-1/2 pr-1` : `w-full pr-1`}
              >
